...
const LANGUAGES = [
  ...
  "Kashmiri", "Manipuri", "Santali", "Bodo", "Any Other"
];
    ...
    >
      <ScrollView style={styles.scrollView}>
          ...
          <View style={styles.inputContainer}>
            ...
            <View style={styles.phoneContainer}>
              ...
              <TextInput
                ...
                onChangeText={(text) => handleUpdate("contactNumber.number", text)}
          ...
          <View style={styles.row}>
            ...
            <View style={[styles.inputContainer, styles.halfWidth]}>
              ...
              <View style={styles.pickerContainer}>
                <Text style={styles.pickerText}>{formData.gender || "Select"}</Text>
              </View>
            </View>
          </View>
        ...
        <View style={styles.section}>
          ...
          {showDatePicker && (
            <DateTimePicker
              value={formData.passportNumber ? new Date(formData.passportNumber) : new Date()}
              mode="date"
              display="default"
